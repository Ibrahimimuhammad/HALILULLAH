...
global.gurl  =process.env.GURL  || "https://wa.me/2347046646271";
global.website=process.env.GURL || "https://wa.me/2347046646271" ; 
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/52e3f397e3817ee4ec5f1.jpg" ; // SET LOGO FOR IMAGE 
...
global.userImages= process.env.USER_IMAGES|| "https://telegra.ph/file/52e3f397e3817ee4ec5f1.jpg",
...
module.exports = {
  ...
  caption : process.env.CAPTION || "✙HALILULLAH●✙" , // ```『 ᴘᴏᴡᴇʀᴇᴅ ʙʏ sᴜʜᴀɪʟ²²¹-ᴍᴅ 』```", //*『sᴜʙsᴄʀɪʙᴇ • sᴜʜᴀɪʟ ᴛᴇᴄʜ』*\n youtube.com/@suhailtechinfo0"),
 
  author: process.env.PACK_AUTHER || "𖣘HALILULLAH",
  packname: process.env.PACK_NAME || "₭ł₦₲ ₥₵ⱤØ₴₴",
  botname : process.env.BOT_NAME  || "⫷HALILULLAH-𝑴𝑫⫸",
  ownername:process.env.OWNER_NAME|| "𖣘HALILULLAH-𝑴𝑫♡●",
  ...
  LANG: process.env.THEME ? process.env.THEME.toUpperCase() : "HALILULLAH",
